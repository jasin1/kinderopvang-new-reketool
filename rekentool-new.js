...
$(".reken_btn").mousedown("click", function () {
    ...
    if(sum_uren == 260){
        ...
        $(".extra_txt").html("U krijgtt een halve dag gratis van ons bij dit gekozen opvang pakket. Normaliter 260 uur maar u ontvangt 30 uur korting dat betekend wat u moet doorgeven aan de belastingdienst is; 230 X &euro;11,45 = &euro;2.633,50 per maand voor 5 hele dagen!");
        $("#korting-txt").val("U krijgtt een halve dag gratis van ons bij dit gekozen opvang pakket. Normaliter 260 uur maar u ontvangt 30 uur korting dat betekend wat u moet doorgeven aan de belastingdienst is; 230 X &euro;11,45 = &euro;2.633,50 per maand voor 5 hele dagen!");
