...
$(".reken_btn").mousedown("click", function () {
    ...
    if(sum_uren == 260){
        ...
        $(".overzicht_kosten_totaal").html("&euro; 2403.50");
        $("#send-totaal").val("&euro; 2403.50");
        ...
        $(".extra_txt").html("U krijgt een halve dag gratis van ons bij dit gekozen opvang pakket. Normaliter 260 uur maar u ontvangt 30 uur korting dat betekend wat u moet doorgeven aan de belastingdienst is; 230 X &euro;10,45 = &euro;2.403,50 per maand voor 5 hele dagen!");
        $("#korting-txt").val("U krijgt een halve dag gratis van ons bij dit gekozen opvang pakket. Normaliter 260 uur maar u ontvangt 30 uur korting dat betekend wat u moet doorgeven aan de belastingdienst is; 230 X &euro;10,45 = &euro;2.403,50 per maand voor 5 hele dagen!");
